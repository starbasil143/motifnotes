...
import { Ban, FilePen } from 'lucide-react';


export default function SoundcloudPlaylistOption({
  playlist,
  onSelectPlaylist
} : {
  ...
  return (
    <Card className='my-2 p-2'>
      <CardHeader className='flex justify-between'>
        ...
        <Button color='primary' radius='lg' isIconOnly onMouseUp={()=>onSelectPlaylist(playlist)}>
          <FilePen />
        </Button>
      </CardHeader>
